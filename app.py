...
# ==========================================
# 💡 مقترحات بطل الأسبوع (الجديد)
# ==========================================
WEEKLY_IDEAS = {
    "❤️ عمل خيري": [
        "شراء كرتون ماء وتوزيه على العمال",
    ...
    "🍉 طعام ولمة": [
        "فطور جماعي بعد صلاة الفجر",
        "عشاء خفيف (نواشف) في بيت أحد الشباب",
        "شاي وقهوة في ممشى أو حديقة",
        "كل واحد يحضر طبق من بيته (Potluck)",
        "آيس كريم أو عصير بعد صلاة العشاء"
    ],
    "⚽ نشاط وترفيه": [
        "مباراة كرة قدم",
        "مشي جماعي لمدة 30 دقيقة",
        "جلسة قراءة وتدبر لآيات قصيرة",
        "مسابقة ثقافية خفيفة",
        "رحلة قصيرة (كشتة) لنصف يوم"
    ]
}
