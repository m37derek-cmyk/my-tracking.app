...
def calculate_score(row):
    ...
    # 3. القرآن (قائمة خيارات ونقاط مختلفة)
    ...
    # 4. قيام الليل (قائمة خيارات ونقاط مختلفة)
    ...
    with st.form("entry_form"):
        ...
        with st.expander("📖 الروحانيات (القرآن والقيام)", expanded=False):
            ...
            with col_z2:
                ...
                # ⚠️ ⚠️ REVENU À LA SÉLECTION DANS UNE LISTE ⚠️ ⚠️
        ...
        if submit:
            ...
            if is_duplicate:
                ...
                row = [
                    ...
                    inputs['qiyam'], # قيمة مختارة
                    inputs['quran'], # قيمة مختارة
